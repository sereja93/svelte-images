...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(46:4) {#if showDownloadBtn}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*showDownloadBtn*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(img, "blur", !/*loaded*/ ctx[3]);
    			toggle_class(img, "after-load", /*afterLoad*/ ctx[4]);
    			toggle_class(img, "loaded", /*loaded*/ ctx[3]);
    			toggle_class(img, "svelte-10nojyy", true);
    			add_location(img, file, 37, 4, 613);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(img, "click", /*onClick*/ ctx[2], false, false, false),
    				action_destroyer(load_action = /*load*/ ctx[5].call(null, img))
    			];
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { showDownloadBtn = false } = $$props;
    	...
    	function load(img) {
    		img.onload = () => {
    			...
    			setTimeout(() => $$invalidate(4, afterLoad = true), 1500);
    		};
    	}

    	const writable_props = ["lazy", "imageProps", "showDownloadBtn", "onClick"];
    	...
    	$$self.$set = $$props => {
    		if ("lazy" in $$props) $$invalidate(6, lazy = $$props.lazy);
    		if ("imageProps" in $$props) $$invalidate(0, imageProps = $$props.imageProps);
    		if ("showDownloadBtn" in $$props) $$invalidate(1, showDownloadBtn = $$props.showDownloadBtn);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("afterLoad" in $$props) $$invalidate(4, afterLoad = $$props.afterLoad);
    	};
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "content svelte-xjvwf3");
    			add_location(div0, file$1, 72, 8, 1536);
    			attr_dev(div1, "class", "window-wrap svelte-xjvwf3");
    			add_location(div1, file$1, 68, 6, 1421);
    			attr_dev(div2, "class", "bg svelte-xjvwf3");
    			add_location(div2, file$1, 63, 4, 1282);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "svelte-xjvwf3");
    			add_location(div, file$1, 61, 0, 1255);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 26, 0, 682);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 198, 20, 5091);
    			attr_dev(svg, "role", "presentation");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", "svelte-1gz98av");
    			add_location(svg, file$3, 197, 16, 5024);
    			attr_dev(button, "class", "svelte-1gz98av");
    			add_location(button, file$3, 196, 12, 4952);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, svg);
    			append_dev(svg, path);
    			/*button_binding_1*/ ctx[20](button);
    			dispose = listen_dev(button, "click", /*right*/ ctx[7], false, false, false);
    		},
    		p: noop,
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(button);
    			/*button_binding_1*/ ctx[20](null);
    			dispose();
    		}
    	};
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 178, 16, 4140);
    			attr_dev(path0, "d", "M9.984 6l6 6-6 6-1.406-1.406 4.594-4.594-4.594-4.594z");
    			add_location(path0, file$3, 181, 24, 4316);
    			attr_dev(svg0, "role", "presentation");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "class", "svelte-1gz98av");
    			add_location(svg0, file$3, 180, 20, 4245);
    			attr_dev(button0, "class", "svelte-1gz98av");
    			add_location(button0, file$3, 179, 16, 4169);
    			attr_dev(path1, "fill", "none");
    			attr_dev(path1, "d", "M0 0h24v24H0z");
    			add_location(path1, file$3, 188, 28, 4656);
    			attr_dev(path2, "d", "M13 10h5l-6 6-6-6h5V3h2v7zm-9 9h16v-7h2v8a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-8h2v7z");
    			add_location(path2, file$3, 189, 28, 4723);
    			add_location(g, file$3, 187, 24, 4623);
    			set_style(svg1, "transform", "scale(0.7)");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			attr_dev(svg1, "class", "svelte-1gz98av");
    			add_location(svg1, file$3, 186, 20, 4542);
    			attr_dev(button1, "class", "svelte-1gz98av");
    			add_location(button1, file$3, 185, 16, 4456);
    			attr_dev(div1, "class", "rr svelte-1gz98av");
    			add_location(div1, file$3, 177, 12, 4106);
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(button0, "click", /*right*/ ctx[7], false, false, false),
    				listen_dev(button1, "click", /*onClickDownload*/ ctx[11], false, false, false)
    			];
    		},
    		p: noop,
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(177:8) {#if showDownloadBtn}",
    		ctx
    	});
    ...
    // (211:12) {#each images as image, i}
    function create_each_block(ctx) {
    	let div;
    	let i = /*i*/ ctx[24];
    	let t;
    	let current;
    	const assign_image = () => /*image_binding*/ ctx[21](image, i);
    	const unassign_image = () => /*image_binding*/ ctx[21](null, i);
    	let image_props = { imageProps: /*image*/ ctx[22] };
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "img-container svelte-1gz98av");
    			add_location(div, file$3, 211, 16, 5621);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			const image_changes = {};
    			if (dirty & /*images*/ 1) image_changes.imageProps = /*image*/ ctx[22];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(211:12) {#each images as image, i}",
    		ctx
    	});
    ...
    // (207:8) <ClickOutside                  className="click-outside-wrapper"                  on:clickoutside={handleClose}                  exclude={[left_nav_button, right_nav_button, ...image_elements, download_element]}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*images, image_elements*/ 33) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(207:8) <ClickOutside                  className=\\\"click-outside-wrapper\\\"                  on:clickoutside={handleClose}                  exclude={[left_nav_button, right_nav_button, ...image_elements, download_element]}>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*showDownloadBtn*/ ctx[1]) return create_if_block$2;
    	...
    	const clickoutside = new ClickOutside({
    			props: {
    				...
    				exclude: [
    					...
    					.../*image_elements*/ ctx[5],
    					/*download_element*/ ctx[4]
    				],
    	...
    	clickoutside.$on("clickoutside", /*handleClose*/ ctx[10]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$3, 171, 16, 3923);
    			attr_dev(svg, "role", "presentation");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "class", "svelte-1gz98av");
    			add_location(svg, file$3, 170, 12, 3860);
    			attr_dev(button, "class", "svelte-1gz98av");
    			add_location(button, file$3, 169, 8, 3794);
    			attr_dev(div0, "class", "nav svelte-1gz98av");
    			add_location(div0, file$3, 168, 4, 3767);
    			attr_dev(div1, "class", "carousel svelte-1gz98av");
    			attr_dev(div1, "style", div1_style_value = `transform: translate3d(${/*translateX*/ ctx[6]}px, 0, 0);`);
    			add_location(div1, file$3, 203, 4, 5236);
    			attr_dev(div2, "class", "container svelte-1gz98av");
    			add_location(div2, file$3, 167, 0, 3738);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				listen_dev(window_1, "resize", /*updatePosition*/ ctx[9], false, false, false),
    				listen_dev(button, "click", /*left*/ ctx[8], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*left_nav_button, right_nav_button, image_elements, download_element*/ 60) clickoutside_changes.exclude = [
    				/*left_nav_button*/ ctx[2],
    				/*right_nav_button*/ ctx[3],
    				.../*image_elements*/ ctx[5],
    				/*download_element*/ ctx[4]
    			...
    			if (dirty & /*$$scope, images, image_elements*/ 33554465) {
    				clickoutside_changes.$$scope = { dirty, ctx };
    			}

    			clickoutside.$set(clickoutside_changes);

    			if (!current || dirty & /*translateX*/ 64 && div1_style_value !== (div1_style_value = `transform: translate3d(${/*translateX*/ ctx[6]}px, 0, 0);`)) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { showDownloadBtn = false } = $$props;
    	let { imageDownloadClickAction = null } = $$props;
    	let left_nav_button;
    	...
    	function right() {
    		$$invalidate(12, curr_idx = increment(curr_idx));
    		updatePosition();
    	}

    	function left() {
    		$$invalidate(12, curr_idx = decrement(curr_idx));
    		updatePosition();
    	}

    	function updatePosition() {
    		$$invalidate(6, translateX = -curr_idx * window.innerWidth);
    	}
    	...
    	const writable_props = ["images", "curr_idx", "showDownloadBtn", "imageDownloadClickAction"];
    	...
    	function button1_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(4, download_element = $$value);
    		});
    	}
    	...
    	function image_binding($$value, i) {
    		...
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			...
    			$$invalidate(5, image_elements);
    		});
    	}

    	$$self.$set = $$props => {
    		if ("images" in $$props) $$invalidate(0, images = $$props.images);
    		if ("curr_idx" in $$props) $$invalidate(12, curr_idx = $$props.curr_idx);
    		if ("showDownloadBtn" in $$props) $$invalidate(1, showDownloadBtn = $$props.showDownloadBtn);
    		if ("imageDownloadClickAction" in $$props) $$invalidate(13, imageDownloadClickAction = $$props.imageDownloadClickAction);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("download_element" in $$props) $$invalidate(4, download_element = $$props.download_element);
    		if ("translateX" in $$props) $$invalidate(6, translateX = $$props.translateX);
    		if ("onClickDownload" in $$props) $$invalidate(11, onClickDownload = $$props.onClickDownload);
    	};
    ...
    class Carousel extends SvelteComponentDev {
    	...
    	get imageDownloadClickAction() {
    		throw new Error("<Carousel>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set imageDownloadClickAction(value) {
    		throw new Error("<Carousel>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    const open$1 = (images, curr_idx, showDownloadBtn, imageDownloadClickAction) => {
      open(Carousel, { images, curr_idx, showDownloadBtn, imageDownloadClickAction });
    };
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(54:2) {#each images as image, i}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block = /*showModal*/ ctx[4] && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			if_block_anchor = empty();
    			attr_dev(div, "class", "svelte-images-gallery svelte-di3cb");
    			set_style(div, "--gutter", /*gutter*/ ctx[1]);
    			add_location(div, file$4, 49, 0, 1132);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Images extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*numCols*/ ctx[2] === undefined && !("numCols" in props)) {
    			console_1.warn("<Images> was created without expected prop 'numCols'");
    		}
    	}
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1q8bqo0");
    			add_location(main, file$5, 15, 0, 270);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
